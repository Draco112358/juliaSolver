...
# !!! Main.UserApp is configured as an alias for Main.JuliaSolver and you might encounter it in some tests
using Main.JuliaSolver, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "JuliaSolver tests" begin
  @includetests ARGS
end
